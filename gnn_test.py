...
parser.add_argument('--index_path', default='./train_valid_index_json/.train_index_random_4', type=str,
                    help='cnn_rnn and gnn unified train and valid ppi index')
parser.add_argument('--gnn_model', default='./save_model/random4/gnn_model_train.ckpt', type=str,
                    help="gnn trained model")
parser.add_argument('--test_all', default='True', type=boolean_string,
